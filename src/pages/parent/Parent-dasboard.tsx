...
export default function ParentDashboard() {
  ...
  const quickActions = [
    { label: 'Check Fees', icon: FileText, variant: 'educational' as const },
    { label: 'View Results', icon: CheckCircle2, variant: 'default' as const },
    { label: 'Message School', icon: Users, variant: 'outline' as const }
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Hello Parent</h1>
