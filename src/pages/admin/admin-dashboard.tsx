...
export default function AdminDashboard() {
  ...
  const quickActions = [
    { label: 'Register New Student', icon: Plus, variant: 'educational' as const },
    { label: 'Add New Staff', icon: Users, variant: 'default' as const },
    { label: 'Generate Reports', icon: FileText, variant: 'outline' as const },
    { label: 'System Settings', icon: CheckCircle2, variant: 'outline' as const }
  ];

  const recentActivity = [
    { text: "15 new student registrations this week", time: "2 hours ago", type: "success" },
    { text: "Fee collection report generated", time: "4 hours ago", type: "info" },
    { text: "System backup completed", time: "1 day ago", type: "success" },
    { text: "Parent meeting scheduled for next week", time: "2 days ago", type: "warning" }
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Hello Administrator!</h1>
