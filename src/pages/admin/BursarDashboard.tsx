...
export default function BursarDashboard() {
  ...
  const quickActions = [
    { label: 'Record Payment', icon: Plus, variant: 'educational' as const },
    { label: 'Generate Invoice', icon: FileText, variant: 'default' as const },
    { label: 'View Defaulters', icon: CheckCircle2, variant: 'warning' as const }
  ];

  const recentActivity = [
    { text: "UGX 2.5M collected via mobile money", time: "30 min ago", type: "success" },
    { text: "Monthly invoices generated", time: "2 hours ago", type: "info" },
    { text: "Payment plan approved for 5 students", time: "1 day ago", type: "success" },
    { text: "Fee reminder sent to 45 parents", time: "3 days ago", type: "warning" }
  ];
